...
const cadastros: Ref<Cadastro[]> = ref([
    ...
    { id: 1, nome: 'Empresa Alpha', documento: '10825310000101', telefone: '51988887777', isBlocked: false },
    { id: 2, nome: 'Maria Lima', documento: '12345678901', telefone: '11999990000', isBlocked: false },
]) as Ref<Cadastro[]>;
...
export const toggleBlockStatus = (id: number): void => {
    ...
    if (index !== -1) {
        ...
        console.log(`Simulando PATCH/PUT para ${id} com isBlocked: ${!currentCad.isBlocked}`);
        
        // Como o array é readonly, usamos Object.assign para alterar o objeto interno
        Object.assign(currentCad, { 
            isBlocked: !currentCad.isBlocked 
        });
